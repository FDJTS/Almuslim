...
# Build Release and package into tar.gz for macOS
...
cmake --build . --config Release -- -j"$(sysctl -n hw.logicalcpu 2>/dev/null || echo 2)"

# Prepare package staging
STAGE="almuslim-macos"
...
OUT="almuslim-macos-${ARCH}.tar.gz"
